...
customer_surface = [[
           ...
           [[pygame.transform.scale( pygame.image.load('graphics/customer/baby/s1.png').convert_alpha(), (200, 300)),
             pygame.transform.scale( pygame.image.load('graphics/customer/baby/s2.png').convert_alpha(), (200, 300))],
